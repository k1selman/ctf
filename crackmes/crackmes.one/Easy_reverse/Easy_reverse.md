...
Let's fire up Ghidra and load our binary into it and study the contents of it - like, for example, functions. In such challenges we have some good chances at being presented with functions like "main" on the spot.<br />
